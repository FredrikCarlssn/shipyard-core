...
contract ERC721DynamicTraits is DynamicTraits, Ownable, ERC721 {
    ...
    string public tokenHash = "QmPQS23UhMwzMQSdxGbaCdrzmgj5Q7ows4BhEzDxSmjBaQ";
    ...
    constructor() Ownable(msg.sender) ERC721("ERC721DynamicTraits", "ERC721DT") {
        _setTraitMetadataURI("ipfs://QmNbdqbsc9HrnXuAqofJVFmAZgjYX5nHJQPi4k73D2BV4P");
        // mint();
    }
    ...
    function mint() public {
        ...
        setMultipleTraitsWithEvent(tokenId, itemTraitKeys, itemTraitValues1);
    }
    ...
    function setMultipleTraitsWithEvent(uint256 tokenId, bytes32[] memory traitKeys, bytes32[] memory traits)
        public
        onlyOwner
    {
        uint256 traitsLength = traitKeys.length;
        for (uint256 i = 0; i < traitsLength; i++) {
            setTrait(tokenId, traitKeys[i], traits[i]);
        }
    }
    ...
    bytes32[] public itemTraitValues1 = [
        bytes32("red"),
        bytes32("blue"),
        bytes32("green"),
        bytes32("yellow"),
    ...
    bytes32[] public itemTraitValues2 = [
        bytes32("large"),
        bytes32("small"),
        bytes32("medium"),
        bytes32("tiny"),
    ...
    function setTokenHash(string calldata newTokenHash) external onlyOwner {
